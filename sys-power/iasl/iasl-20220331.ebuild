...
SRC_URI="
	https://www.acpica.org/sites/acpica/files/${MY_P}.tar.gz
	test? ( https://www.acpica.org/sites/acpica/files/${MY_TESTS_P}.tar.gz )"
...
#mv /var/cache/distfiles/${MY_P}.tar_0.gz /var/cache/distfiles/${MY_P}.tar.gz
